...
const App = () => {
  const [count, setCount] = useState(0); // count es la variable que recibe el valor.
  //setCount es una función que requiere el nuevo valor del estado, y éste modifica el valor de la variable count.
