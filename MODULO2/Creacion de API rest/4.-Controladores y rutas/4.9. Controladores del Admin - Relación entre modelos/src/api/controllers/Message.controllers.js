...
const createMessage = async (req, res, next) => {
  try {
     ...
     * Por tanto, con el findById nos traemos user, character o movie de la base de datos.
     */
    ...
    if (findUser) {
      ...
      if (type == "private") {
        //si es privado, va  a haber 2 user. Lo que voy a hacer es buscar de quién es el chat
        try {
